...
exports.createRole = (0, express_async_handler_1.default)(async (req, res) => {
    const { name } = req.body;
    const role = await user_role_model_1.default.create({ name });
    try {
        await (0, publisher_1.publishEvent)("user_events", "USER_ROLE_CREATED", {
            roleId: role.id,
            roleName: role.name,
        });
    }
...
exports.getRoles = (0, express_async_handler_1.default)(async (req, res) => {
    const roles = await user_role_model_1.default.findAll();
    res.status(200).json({ success: true, data: roles });
});
exports.getRole = (0, express_async_handler_1.default)(async (req, res) => {
    const { id } = req.params;
    const role = await user_role_model_1.default.findByPk(id);
    if (!role) {
...
exports.updateRole = (0, express_async_handler_1.default)(async (req, res) => {
    ...
    try {
        await (0, publisher_1.publishEvent)("user_events", "USER_ROLE_UPDATED", {
            roleId: role.id,
            roleName: role.name,
        });
    }
...
exports.deleteRole = (0, express_async_handler_1.default)(async (req, res) => {
    ...
    await role.destroy();
    try {
        await (0, publisher_1.publishEvent)("user_events", "USER_ROLE_DELETED", {
            roleId: role.id,
        });
    }
    catch (err) {
